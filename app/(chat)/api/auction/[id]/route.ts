...
const data = {
  1: { 
    ...
    manufacturerDetails: {
      location: "India",
      established: 2010,
      description: "Indie studio is a small studio that makes small things for small people."
    },
  ...
  2: { 
    ...
    manufacturer: "Indie studio",
    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRraioFPrd6TdDj8l8eWT8NeyINr1s_RCoGfA&s",
    manufacturerUrl : "https://assets.astaguru.com/walter_langhammer.jpg",
    manufacturerDetails: {
      location: "India",
      established: 2010,
  ...
  3: { 
    ...
    manufacturer: "Indie studio",
    imageUrl: "https://harpersbazaaruk.cdnds.net/17/04/4000x2000/gallery-1485277925-slide-3cover.jpg",
    manufacturerUrl : "https://assets.astaguru.com/walter_langhammer.jpg",
    manufacturerDetails: {
      location: "India",
      established: 2010,
  ...
  4: { 
    ...
    manufacturer: "Indie studio",
    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMwrAVaHYjY-uKmMjBLFgO8nP4gD_7DEWGYA&s",
    manufacturerUrl : "https://assets.astaguru.com/walter_langhammer.jpg",
    manufacturerDetails: {
      location: "India",
      established: 2010,
...
export async function GET(req: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const item = data[parseInt(id) as keyof typeof data];
